...
const AboutSec5 = ({ data }) => {
  ...
  const handleSaveText = async () => {
    ...
    try {
      ...
      const result = await updateText('about', 'about-sec5', title, null, description);
  ...
  const handleSaveBgImage = async () => {
    ...
    try {
      ...
      if (bgImageFile) {
        const result = await updateBgImage('about', 'about-sec5', bgImageFile, 0);
  ...
  return (
    <div className="about-sec5 container" style={{borderBottom: '1px solid #ccc', padding: '0 0 50px 0'}}>
      {/* Section Header */}
