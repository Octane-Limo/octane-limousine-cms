...
const OurFleetSec1 = ({ data }) => {
//   console.log("Our Fleet sec 1 data: ", data);
  ...
  const handleSaveText = async () => {
    ...
    try {
      ...
      const result = await updateText('our-fleets', 'our-fleets-sec1', title, subtitle, description);
  ...
  const handleSaveBgImage = async () => {
    ...
    try {
      ...
      if (bgImageFile) {
        const result = await updateBgImage('our-fleets', 'our-fleets-sec1', bgImageFile, 0);
...
const handleSaveCarImage = async (carIndex) => {
  ...
  updatedBgImages[0].url = previewUrl;  // Add this line to show preview
  ...
  return (
    <div className="our-fleets-sec1 container my-4" style={{borderBottom: '1px solid #ccc', padding: '0 0 50px 0'}}>
      {/* Section Header */}
